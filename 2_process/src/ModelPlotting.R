...
### This function returns the clean dataframe, which can then be inputted into the next plot function
...
### Function 3 - Save the processed data in given output location
...
### Function 4 - plots the data processed above and saved it in the output folder location 
